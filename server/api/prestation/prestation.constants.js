...
exports.all = [
  {
    ...
    description: 'La carte européenne de stationnement permet à son titulaire ou à la personne qui \
      l\'accompagne de stationner sur les places réservées aux personnes handicapées.',
  ...
  },
  {
    ...
    description: 'La carte d\'invalidité civile a pour but d\'attester que son détenteur est handicapé \
      et permet de bénéficier de certains droits spécifiques, notamment dans les transports.',
  ...
  },
  {
    ...
    description: 'L\'allocation d\'éducation de l\'enfant handicapé (AEEH) est destinée à soutenir les \
      personnes qui assurent la charge d\'un enfant en situation de handicap.',
  ...
  },
  {
    ...
    description: 'L\'allocation aux adultes handicapés (AAH) est versée, sous conditions de ressources, \
      aux adultes déclarés handicapés afin de leur assurer un revenu minimum.',
  ...
  },
  {
    ...
    description: 'La prestation de compensation du handicap (PCH) est une aide personnalisée destinée à \
      financer les besoins liés à la perte d\'autonomie des personnes handicapées.',
  ...
  },
  {
    ...
    description: 'Un travailleur handicapé est une personne dont les possibilités d\'obtenir ou de conserver \
      un emploi sont réduites à cause de son handicap. Il peut s\'agir de l\'altération d\'une ou plusieurs \
  ...
  },
  {
    ...
    description: 'L\'affiliation à l\'assurance vieillesse permet à l\'aidant familial de valider des trimestres \
      pour sa retraite sans qu\'il ait besoin de verser des cotisations auprès de sa caisse de retraite.',
  ...
  },
  {
    ...
    description: 'Le PPS fait partie du Plan de compensation du handicap (PCH). Il définit les modalités de \
      déroulement de la scolarité et les actions pédagogiques, psychologiques, éducatives,sociales, médicales \
        et paramédicales répondant aux besoins particuliers des élèves présentant un handicap.'
  },
  {
    id: 'orp',
    type: 'presta-accompagnement',
    ...
    description: 'La demande d\'Orientation professionnelle vise à définir le milieu de travail dans lequel la \
