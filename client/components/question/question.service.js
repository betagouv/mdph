...
angular.module('impactApp')
  .factory('QuestionService', function QuestionService(FormService, identite, autorite, contexte, vieQuotidienne, vieScolaire, travail, aidant, aidePartenaire, renouvellement) {
