...
angular.module('impactApp')
  .factory('QuestionService', function QuestionService(FormService, identite, contexte, vieQuotidienne, vieScolaire, travail, aidant, aidePartenaire, renouvellement) {
